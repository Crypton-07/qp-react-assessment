...
const ToDoForm: React.FC<PropTypes> = ({ setTodo }) => {
  ...
  return (
    <div className="w-full flex items-center justify-around space-x-4 px-4 py-4 shadow-lg">
      <input
      ...
      <button
        title="add task"
        className="w-auto bg-gray-900 text-white py-3 px-5 shadow-md rounded-md font-medium tracking-wide active:scale-90 transition-all ease-in duration-200 uppercase"
      ...
      <button
        title="search"
        className="w-auto bg-gray-900 text-white py-3 px-4 shadow-md rounded-md font-medium tracking-wide active:scale-90 transition-all ease-in duration-200 uppercase"
